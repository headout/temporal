#!/bin/bash
# Post-rewrite telemetry — re-maps AI attribution after rebase/amend. Async.
...
exec "$(dirname "${BASH_SOURCE[0]}")/hac-dispatch-ho.sh" --git-bg post-rewrite-telemetry-ho "$REPO_ROOT"
