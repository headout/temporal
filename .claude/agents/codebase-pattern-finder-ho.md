...
description: "Finds similar implementations, usage examples, and existing conventions, returning concrete code snippets to model new work after. Use proactively when you need examples of how something is done in the codebase, patterns to follow, or existing usages before implementing."
---
