...
description: "Analyzes how specific components are implemented and returns detailed explanations of internals, data flow, and how the pieces connect. Use proactively when you need to understand how a feature works, trace request-to-response flow, or deep-dive a component before changing it."
---
